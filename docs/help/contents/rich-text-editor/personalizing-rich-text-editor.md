...
**$headline$**: Up to first 100 characters of the note's content (paragraph or heading). This will keep updating the title as headline of the note changes until you manually edit the title. Shouldn't be used in combination with other templates.
