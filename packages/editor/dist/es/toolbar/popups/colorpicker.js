            ...
            //  width: ["auto", 250],
                    ...
                    alignItems: "center",
                            ...
                            flexWrap: ["nowrap", "wrap"],
                                    ...
                                    p: 0,
                                    ml: [2, 2, 1],
                                }, onClick: () => setIsPickerOpen((s) => !s) }, { children: _jsx(Icon, { path: Icons.palette, color: tColor.isDark() ? "static" : "icon", size: 18 }) })), colors.map((color) => (_jsx(Button, { variant: "secondary", sx: {
                                    flex: "0 0 auto",
                                    bg: color,
                                    width: PALETTE_SIZE,
                                    height: PALETTE_SIZE,
