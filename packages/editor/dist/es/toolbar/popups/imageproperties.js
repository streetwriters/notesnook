...
export function ImageProperties(props) {
    ...
    return (_jsx(Popup, Object.assign({ title: "Image properties", onClose: onClose }, { children: _jsxs(Flex, Object.assign({ sx: { width: ["auto", 300], flexDirection: "column", p: 1 } }, { children: [_jsxs(Flex, Object.assign({ sx: { justifyContent: "space-between", alignItems: "center" } }, { children: [_jsx(Text, Object.assign({ variant: "body" }, { children: "Floating?" })), _jsx(Checkbox, { checked: float, onClick: () => editor
                                .chain()
