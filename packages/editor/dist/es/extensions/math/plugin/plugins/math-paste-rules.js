 ...
 * ```
 */
export const wikipediaBlockMathParseRule = {
    tag: "dl",
    getAttrs(p) {
        let dl = p;
 ...
 * ```
 */
export const wikipediaInlineMathParseRule = {
    tag: "span",
    getAttrs(p) {
        let span = p;
...
// -- MathJax ------------------------------------------- //
////////////////////////////////////////////////////////////
export const defaultInlineMathParseRules = [
    wikipediaInlineMathParseRule,
];
export const defaultBlockMathParseRules = [
