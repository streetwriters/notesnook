...
function ImageProperties(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(popup_1.Popup, Object.assign({ title: "Image properties", onClose: onClose }, { children: (0, jsx_runtime_1.jsxs)(rebass_1.Flex, Object.assign({ sx: { width: ["auto", 300], flexDirection: "column", p: 1 } }, { children: [(0, jsx_runtime_1.jsx)(responsive_1.DesktopOnly, { children: (0, jsx_runtime_1.jsxs)(forms_1.Label, Object.assign({ variant: "text.body", sx: { justifyContent: "space-between", alignItems: "center" } }, { children: ["Float image", (0, jsx_runtime_1.jsx)(forms_1.Checkbox, { checked: float, onClick: () => editor
                                    .chain()
