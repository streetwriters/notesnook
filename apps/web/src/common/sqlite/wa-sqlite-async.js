var Module = (() => {
  ...
  return function (config) {
    ...
    function oa(b, c, d) {
      var e = c + d;
      for (d = c; b[d] && !(d >= e); ) ++d;
      if (16 < d - c && b.buffer && na) return na.decode(b.subarray(c, d));
      for (e = ""; c < d; ) {
        var f = b[c++];
        if (f & 128) {
          var g = b[c++] & 63;
    ...
    var A, y, B, sa, C, E, ta, ua;
    function va() {
      var b = ma.buffer;
      a.HEAP8 = A = new Int8Array(b);
      a.HEAP16 = B = new Int16Array(b);
      a.HEAP32 = C = new Int32Array(b);
      a.HEAPU8 = y = new Uint8Array(b);
      a.HEAPU16 = sa = new Uint16Array(b);
      a.HEAPU32 = E = new Uint32Array(b);
      a.HEAPF32 = ta = new Float32Array(b);
      a.HEAPF64 = ua = new Float64Array(b);
    }
    var wa,
      xa = [],
      ya = [],
    ...
    var F;
    if (a.locateFile) {
      if (((F = "wa-sqlite-async.wasm"), !Fa())) {
        var Ga = F;
        F = a.locateFile ? a.locateFile(Ga, m) : m + Ga;
      }
    } else F = new URL("wa-sqlite-async.wasm", import.meta.url).href;
    function Ha() {
      var b = F;
      try {
        if (b == F && la) return new Uint8Array(la);
        if (ia) return ia(b);
    ...
    var Ua = {
        ...
        read: function (b, c, d, e) {
          if (!b.Tf || !b.Tf.cg.zg) throw new O(60);
          for (var f = 0, g = 0; g < e; g++) {
            try {
              var h = b.Tf.cg.zg(b.Tf);
            } catch (n) {
              throw new O(29);
            }
            if (void 0 === h && 0 === f) throw new O(6);
        ...
        write: function (b, c, d, e) {
          if (!b.Tf || !b.Tf.cg.sg) throw new O(60);
          try {
            for (var f = 0; f < e; f++) b.Tf.cg.sg(b.Tf, c[d + f]);
          } catch (g) {
            throw new O(29);
          }
      ...
      Va = {
        ...
        ig: function (b) {
          b.Sf && 0 < b.Sf.length && (ka(oa(b.Sf, 0)), (b.Sf = []));
        }
      },
      Wa = {
        sg: function (b, c) {
        ...
        ig: function (b) {
          b.Sf && 0 < b.Sf.length && (t(oa(b.Sf, 0)), (b.Sf = []));
        }
      },
      P = {
        Wf: null,
        ...
        createNode: function (b, c, d, e) {
          if (24576 === (d & 61440) || 4096 === (d & 61440)) throw new O(63);
          P.Wf ||
            (P.Wf = {
              dir: {
                node: {
              ...
              link: {
                node: { Uf: P.Mf.Uf, Rf: P.Mf.Rf, gg: P.Mf.gg },
                stream: {}
              },
              wg: { node: { Uf: P.Mf.Uf, Rf: P.Mf.Rf }, stream: Xa }
            });
          d = Ya(b, c, d, e);
          16384 === (d.mode & 61440)
            ? ((d.Mf = P.Wf.dir.node), (d.Nf = P.Wf.dir.stream), (d.Of = {}))
            : 32768 === (d.mode & 61440)
            ? ((d.Mf = P.Wf.file.node),
              (d.Nf = P.Wf.file.stream),
              (d.Qf = 0),
              (d.Of = null))
            : 40960 === (d.mode & 61440)
            ? ((d.Mf = P.Wf.link.node), (d.Nf = P.Wf.link.stream))
            : 8192 === (d.mode & 61440) &&
              ((d.Mf = P.Wf.wg.node), (d.Nf = P.Wf.wg.stream));
          d.timestamp = Date.now();
          b && ((b.Of[c] = d), (b.timestamp = d.timestamp));
          return d;
        },
        Vg: function (b) {
          return b.Of
            ? b.Of.subarray
              ? b.Of.subarray(0, b.Qf)
              : new Uint8Array(b.Of)
            : new Uint8Array(0);
        },
        xg: function (b, c) {
          var d = b.Of ? b.Of.length : 0;
          d >= c ||
            ((c = Math.max(c, (d * (1048576 > d ? 2 : 1.125)) >>> 0)),
            0 != d && (c = Math.max(c, 256)),
            (d = b.Of),
            (b.Of = new Uint8Array(c)),
            0 < b.Qf && b.Of.set(d.subarray(0, b.Qf), 0));
        },
        Rg: function (b, c) {
          if (b.Qf != c)
            if (0 == c) (b.Of = null), (b.Qf = 0);
            else {
              var d = b.Of;
              b.Of = new Uint8Array(c);
              d && b.Of.set(d.subarray(0, Math.min(c, b.Qf)));
              b.Qf = c;
            }
        },
        Mf: {
          ...
          Dg: function (b, c, d) {
            if (16384 === (b.mode & 61440)) {
              ...
              if (e) for (var f in e.Of) throw new O(55);
            }
            delete b.parent.Of[b.name];
          ...
          Cg: function (b) {
            var c = [".", ".."],
              d;
            for (d in b.Of) b.Of.hasOwnProperty(d) && c.push(d);
            return c;
          },
          ng: function (b, c, d) {
            b = P.createNode(b, c, 41471, 0);
            b.link = d;
            return b;
          },
          gg: function (b) {
            if (40960 !== (b.mode & 61440)) throw new O(28);
            return b.link;
          }
        },
        Nf: {
          read: function (b, c, d, e, f) {
            var g = b.node.Of;
            if (f >= b.node.Qf) return 0;
            b = Math.min(b.node.Qf - f, e);
            if (8 < b && g.subarray) c.set(g.subarray(f, f + b), d);
            else for (e = 0; e < b; e++) c[d + e] = g[f + e];
            return b;
          },
          write: function (b, c, d, e, f, g) {
            c.buffer === A.buffer && (g = !1);
            if (!e) return 0;
            b = b.node;
            b.timestamp = Date.now();
            if (c.subarray && (!b.Of || b.Of.subarray)) {
              if (g) return (b.Of = c.subarray(d, d + e)), (b.Qf = e);
              if (0 === b.Qf && 0 === f)
                return (b.Of = c.slice(d, d + e)), (b.Qf = e);
              if (f + e <= b.Qf) return b.Of.set(c.subarray(d, d + e), f), e;
            }
            P.xg(b, f + e);
            if (b.Of.subarray && c.subarray) b.Of.set(c.subarray(d, d + e), f);
            else for (g = 0; g < e; g++) b.Of[f + g] = c[d + g];
            b.Qf = Math.max(b.Qf, f + e);
            return e;
          },
          $f: function (b, c, d) {
            1 === d
              ? (c += b.position)
              : 2 === d && 32768 === (b.node.mode & 61440) && (c += b.node.Qf);
            if (0 > c) throw new O(28);
            return c;
          },
          vg: function (b, c, d) {
            P.xg(b.node, c + d);
          ...
          kg: function (b, c, d, e, f) {
            if (32768 !== (b.node.mode & 61440)) throw new O(43);
            b = b.node.Of;
            if (f & 2 || b.buffer !== A.buffer) {
              if (0 < d || d + c < b.length)
                b.subarray
                  ? (b = b.subarray(d, d + c))
              ...
              (f = ab(65536, c)) ? (y.fill(0, f, f + c), (c = f)) : (c = 0);
              if (!c) throw new O(48);
              A.set(b, c);
      ...
      S = (b, c = {}) => {
        ...
        c = Object.assign({ yg: !0, tg: 0 }, c);
        if (8 < c.tg) throw new O(32);
        b = b.split("/").filter((h) => !!h);
        for (var d = bb, e = "/", f = 0; f < b.length; f++) {
          var g = f === b.length - 1;
          if (g && c.parent) break;
          d = $a(d, b[f]);
          e = N(e + "/" + b[f]);
          d.ag && (!g || (g && c.yg)) && (d = d.ag.root);
          if (!g || c.Zf)
            for (g = 0; 40960 === (d.mode & 61440); )
              if (
                ((d = fb(e)),
                (e = Pa(Ma(e), d)),
                (d = S(e, { tg: c.tg + 1 }).node),
                40 < g++)
              )
                throw new O(32);
        }
      ...
      hb = (b, c) => {
        ...
        return ((b + d) >>> 0) % R.length;
      },
      ib = (b) => {
        var c = hb(b.parent.id, b.name);
        if (R[c] === b) R[c] = b.bg;
        else
          for (c = R[c]; c; ) {
            if (c.bg === b) {
      ...
      $a = (b, c) => {
        var d;
        if ((d = (d = jb(b, "x")) ? d : b.Mf.dg ? 0 : 2)) throw new O(d, b);
        for (d = R[hb(b.id, c)]; d; d = d.bg) {
          var e = d.name;
      ...
      ob = (b, c, d) => {
        ...
        if ((b = jb(b, "wx"))) return b;
        if (d) {
          if (16384 !== (e.mode & 61440)) return 54;
          if (e === e.parent || "/" === gb(e)) return 10;
        } else if (16384 === (e.mode & 61440)) return 31;
        return 0;
      },
      pb = (b = 0) => {
        for (; 4096 >= b; b++) if (!Q[b]) return b;
        throw new O(33);
      },
      rb = (b, c) => {
        qb ||
      ...
      Xa = {
        open: (b) => {
          b.Nf = cb[b.node.fg].Nf;
          b.Nf.open && b.Nf.open(b);
        },
        $f: () => {
          throw new O(70);
        }
      ...
      sb = (b, c) => {
        var d = "/" === c,
          e = !c;
        if (d && bb) throw new O(10);
        if (!d && !e) {
          var f = S(c, { yg: !1 });
          c = f.path;
          f = f.node;
          if (f.ag) throw new O(10);
          if (16384 !== (f.mode & 61440)) throw new O(54);
        }
        c = { type: b, Wg: {}, Ag: c, Ng: [] };
        b = b.Vf(c);
        b.Vf = c;
        c.root = b;
        d ? (bb = b) : f && ((f.ag = c), f.Vf && f.Vf.Ng.push(c));
      },
      tb = (b, c, d) => {
        var e = S(b, { parent: !0 }).node;
        b = Na(b);
        if (!b || "." === b || ".." === b) throw new O(28);
        var f = nb(e, b);
        if (f) throw new O(f);
        if (!e.Mf.jg) throw new O(63);
        return e.Mf.jg(e, b, c, d);
      },
      T = (b, c) => tb(b, ((void 0 !== c ? c : 511) & 1023) | 16384, 0),
      ub = (b, c, d) => {
        "undefined" == typeof d && ((d = c), (c = 438));
        tb(b, c | 8192, d);
      },
      vb = (b, c) => {
        if (!Pa(b)) throw new O(44);
        var d = S(c, { parent: !0 }).node;
        if (!d) throw new O(44);
        c = Na(c);
        var e = nb(d, c);
        if (e) throw new O(e);
        if (!d.Mf.ng) throw new O(63);
        d.Mf.ng(d, c, b);
      },
      wb = (b) => {
        ...
        var d = $a(c, b),
          e = ob(c, b, !0);
        if (e) throw new O(e);
        if (!c.Mf.mg) throw new O(63);
        if (d.ag) throw new O(10);
        c.Mf.mg(c, b);
        ib(d);
      },
      fb = (b) => {
        b = S(b).node;
        if (!b) throw new O(44);
        if (!b.Mf.gg) throw new O(28);
        return Pa(gb(b.parent), b.Mf.gg(b));
      },
      xb = (b, c) => {
        b = S(b, { Zf: !c }).node;
        if (!b) throw new O(44);
        if (!b.Mf.Uf) throw new O(63);
        return b.Mf.Uf(b);
      },
      yb = (b) => xb(b, !0),
      zb = (b, c) => {
        b = "string" == typeof b ? S(b, { Zf: !0 }).node : b;
        if (!b.Mf.Rf) throw new O(63);
        b.Mf.Rf(b, {
      ...
      Ab = (b, c) => {
        ...
        b = "string" == typeof b ? S(b, { Zf: !0 }).node : b;
        if (!b.Mf.Rf) throw new O(63);
        if (16384 === (b.mode & 61440)) throw new O(31);
        if (32768 !== (b.mode & 61440)) throw new O(28);
        var d = jb(b, "w");
        if (d) throw new O(d);
        b.Mf.Rf(b, { size: c, timestamp: Date.now() });
      },
      Cb = (b, c, d) => {
        if ("" === b) throw new O(44);
        if ("string" == typeof c) {
        ...
        if ("object" == typeof b) var f = b;
          ...
          b = N(b);
          try {
            f = S(b, { Zf: !(c & 131072) }).node;
          } catch (g) {}
        }
        e = !1;
        if (c & 64)
          if (f) {
            if (c & 128) throw new O(20);
          } else (f = tb(b, d, 0)), (e = !0);
        if (!f) throw new O(44);
        8192 === (f.mode & 61440) && (c &= -513);
        if (c & 65536 && 16384 !== (f.mode & 61440)) throw new O(54);
        if (
          !e &&
          (d = f
            ? 40960 === (f.mode & 61440)
              ? 32
              : 16384 === (f.mode & 61440) && ("r" !== mb(c) || c & 512)
              ? 31
              : jb(f, mb(c))
            : 44)
        )
        ...
        f.Nf.open && f.Nf.open(f);
        !a.logReadFiles || c & 1 || (Bb || (Bb = {}), b in Bb || (Bb[b] = 1));
        return f;
      },
      Db = (b, c, d) => {
        if (null === b.Xf) throw new O(8);
        if (!b.seekable || !b.Nf.$f) throw new O(70);
        if (0 != d && 1 != d && 2 != d) throw new O(28);
        b.position = b.Nf.$f(b, c, d);
        b.Ug = [];
      },
      Eb = () => {
        O ||
          ...
          [44].forEach((b) => {
            Za[b] = new O(b);
            Za[b].stack = "<generic error, no stack>";
          }));
      },
      Fb,
      Gb = (b, c) => {
    ...
    function Kb(b, c, d) {
      try {
        ...
        if (g && g.node && N(c) !== N(gb(g.node))) return -54;
        throw g;
      }
      C[d >> 2] = e.Jg;
      C[(d + 8) >> 2] = e.qg;
    ...
    function Nb(b) {
      return E[b >> 2] + 4294967296 * C[(b + 4) >> 2];
    }
    var Ob = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
      Pb = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334];
    function Qb(b) {
      var c = ra(b) + 1,
        d = Rb(c);
      d && pa(b, A, d, c);
    ...
    function Tb() {
      if (!Ub) {
        var b = {
          ...
          c;
        for (c in Sb) void 0 === Sb[c] ? delete b[c] : (b[c] = Sb[c]);
        var d = [];
    ...
    function Vb(b, c) {
      Vb.Bg || (Vb.Bg = Oa());
      for (var d = 0; d < c; d++) A[(b + d) >> 0] = Vb.Bg();
      return 0;
    }
    function Wb() {}
    function Xb() {}
    ...
    function Hc() {}
    function Ic(b) {
      b instanceof Ja || "unwind" == b || ea(1, b);
    }
    function Jc(b) {
      try {
        b();
                  ...
                  try {
                    ...
                    v ||
                      ...
                      X &&
                        ...
                        ((Y = 0),
                        Jc(Mc),
                        "undefined" != typeof Fibers && Fibers.Xg()));
                  }
                }
              : f;
        })(d);
        ...
        if (0 === Y) {
          ...
          b((e) => {
            if (!v && ((Nc = e || 0), (c = !0), d)) {
              Y = 2;
              Jc(() => Wc(X));
              "undefined" != typeof Xc && Xc.rg.Lg && Xc.rg.resume();
              e = !1;
              try {
                var f = (0, a.asm[Pc[C[(X + 8) >> 2]]])();
              } catch (n) {
                (f = n), (e = !0);
              }
              var g = !1;
              if (!X) {
                var h = Rc;
                h && ((Rc = null), (e ? h.reject : h.resolve)(f), (g = !0));
              }
              if (e && !g) throw f;
            }
          });
          ...
          c ||
            ((Y = 1),
            (X = Uc()),
            "undefined" != typeof Xc && Xc.rg.Lg && Xc.rg.pause(),
            Jc(() => Yc(X)));
        } else
          2 === Y
            ? ((Y = 0),
    ...
    function Z(b, c, d, e, f) {
      function g(q) {
        0 !== k && fd(k);
        return "string" === c ? x(q) : "boolean" === c ? !!q : q;
      }
      var h = {
        string: (q) => {
          var r = 0;
      ...
      if (e)
        for (var l = 0; l < e.length; l++) {
          var p = h[d[l]];
          p ? (0 === k && (k = hd()), (n[l] = p(e[l]))) : (n[l] = e[l]);
        }
      d = X;
      e = b.apply(null, n);
      f = f && f.async;
      if (X != d) return Tc().then(g);
      e = g(e);
    ...
    (function () {
      ...
      a.setAuthorizer = function (c, d, e) {
        d ? b.set(c, { f: d, ug: e }) : b.delete(c);
        return Z("set_authorizer", "number", ["number"], [c]);
      };
      Wb = function (c, d, e, f, g, h) {
        if (b.has(c)) {
          const { f: n, ug: k } = b.get(c);
          return n(
            k,
            d,
            e ? x(e) : null,
    ...
    (function () {
      const b = new Map(),
        c = new Map();
      a.createFunction = function (d, e, f, g, h, n) {
        const k = b.size;
        b.set(k, { f: n, Yf: h });
        return Z(
          "create_function",
      ...
      a.createAggregate = function (d, e, f, g, h, n, k) {
        const l = b.size;
        b.set(l, { step: n, Kg: k, Yf: h });
        return Z(
          "create_function",
          "number",
          "number string number number number number".split(" "),
      ...
      Yb = function (d, e, f, g) {
        d = b.get(d);
        c.set(e, d.Yf);
        d.f(e, new Uint32Array(y.buffer, g, f));
        c.delete(e);
      };
      $b = function (d, e, f, g) {
        d = b.get(d);
        c.set(e, d.Yf);
        d.step(e, new Uint32Array(y.buffer, g, f));
        c.delete(e);
      };
      Xb = function (d, e) {
        d = b.get(d);
    ...
    (function () {
      ...
      a.progressHandler = function (c, d, e, f) {
        e ? b.set(c, { f: e, ug: f }) : b.delete(c);
        return Z("progress_handler", null, ["number", "number"], [c, d]);
      };
      Zb = function (c) {
        if (b.has(c)) {
          const { f: d, ug: e } = b.get(c);
          return d(e);
        }
        return 0;
      };
    ...
    (function () {
      ...
      qc = function (k, l, p, q) {
        n.set(x(k), {
          size: l,
          eg: Array.from(new Uint32Array(y.buffer, q, p))
        });
      };
      a.createModule = function (k, l, p, q) {
        c && (p.handleAsync = ad);
        const r = d.size;
        d.set(r, { module: p, Yf: q });
        q = 0;
        p.xCreate && (q |= 1);
        p.xConnect && (q |= 2);
        p.xBestIndex && (q |= 4);
      ...
      gc = function (k, l, p, q, r, w) {
        ...
        q = Array.from(new Uint32Array(y.buffer, q, p)).map((z) => x(z));
        return l.module.xCreate(k, l.Yf, q, r, b("Int32", w));
      };
      fc = function (k, l, p, q, r, w) {
        l = d.get(l);
        e.set(r, l);
        if (c) {
          g.delete(r);
        ...
        q = Array.from(new Uint32Array(y.buffer, q, p)).map((z) => x(z));
        return l.module.xConnect(k, l.Yf, q, r, b("Int32", w));
      };
      bc = function (k, l) {
        var p = e.get(k),
          q = n.get("sqlite3_index_info").eg;
        const r = {};
        r.nConstraint = L(l + q[0], "i32");
        r.aConstraint = [];
        var w = L(l + q[1], "*"),
          z = n.get("sqlite3_index_constraint").size;
        for (var G = 0; G < r.nConstraint; ++G) {
          var D = r.aConstraint,
            J = D.push,
            H = w + G * z,
            ja = n.get("sqlite3_index_constraint").eg,
            W = {};
          W.iColumn = L(H + ja[0], "i32");
          W.op = L(H + ja[1], "i8");
          W.usable = !!L(H + ja[2], "i8");
          J.call(D, W);
        }
        r.nOrderBy = L(l + q[2], "i32");
        r.aOrderBy = [];
        w = L(l + q[3], "*");
        z = n.get("sqlite3_index_orderby").size;
        for (G = 0; G < r.nOrderBy; ++G)
          (D = r.aOrderBy),
            (J = D.push),
            (H = w + G * z),
            (ja = n.get("sqlite3_index_orderby").eg),
            (W = {}),
            (W.iColumn = L(H + ja[0], "i32")),
            (W.desc = !!L(H + ja[1], "i8")),
            J.call(D, W);
        ...
        r.idxNum = L(l + q[5], "i32");
        r.idxStr = null;
        r.orderByConsumed = !!L(l + q[8], "i8");
        r.estimatedCost = L(l + q[9], "double");
        r.estimatedRows = L(l + q[10], "i32");
        r.idxFlags = L(l + q[11], "i32");
        r.colUsed = L(l + q[12], "i32");
        k = p.module.xBestIndex(k, r);
        p = n.get("sqlite3_index_info").eg;
        q = L(l + p[4], "*");
        w = n.get("sqlite3_index_constraint_usage").size;
        for (J = 0; J < r.nConstraint; ++J)
          (z = q + J * w),
            (D = r.aConstraintUsage[J]),
            (H = n.get("sqlite3_index_constraint_usage").eg),
            M(z + H[0], D.argvIndex, "i32"),
            M(z + H[1], D.omit ? 1 : 0, "i8");
        M(l + p[5], r.idxNum, "i32");
        "string" === typeof r.idxStr &&
          ...
          M(l + p[6], w, "*"),
          M(l + p[7], 1, "i32"));
        M(l + p[8], r.orderByConsumed, "i32");
        M(l + p[9], r.estimatedCost, "double");
        M(l + p[10], r.estimatedRows, "i32");
        M(l + p[11], r.idxFlags, "i32");
        return k;
      };
      ic = function (k) {
        const l = e.get(k);
        c ? g.add(k) : e.delete(k);
      ...
      mc = function (k, l) {
        ...
        return p.module.xOpen(k, l);
      };
      cc = function (k) {
        const l = f.get(k);
        c ? h.add(k) : f.delete(k);
        return l.module.xClose(k);
      };
      jc = function (k) {
        return f.get(k).module.xEof(k) ? 1 : 0;
      };
      kc = function (k, l, p, q, r) {
        const w = f.get(k);
        p = p ? x(p) : null;
        r = new Uint32Array(y.buffer, r, q);
        return w.module.xFilter(k, l, p, r);
      };
      lc = function (k) {
        return f.get(k).module.xNext(k);
      };
      dc = function (k, l, p) {
        return f.get(k).module.xColumn(k, l, p);
      };
      pc = function (k, l) {
        return f.get(k).module.xRowid(k, b("BigInt64", l));
      };
      sc = function (k, l, p, q) {
        const r = e.get(k);
        p = new Uint32Array(y.buffer, p, l);
        return r.module.xUpdate(k, p, b("BigInt64", q));
      };
      ac = function (k) {
        return e.get(k).module.xBegin(k);
      };
      rc = function (k) {
        return e.get(k).module.xSync(k);
      };
      ec = function (k) {
        return e.get(k).module.xCommit(k);
      };
      oc = function (k) {
        return e.get(k).module.xRollback(k);
      };
      nc = function (k, l) {
        const p = e.get(k);
        l = x(l);
        return p.module.xRename(k, l);
      };
    })();
    (function () {
      function b(g, h) {
        const n = `get${g}`,
          k = `set${g}`;
        return new Proxy(new DataView(y.buffer, h, "Int32" === g ? 4 : 8), {
          get(l, p) {
            if (p === n)
              return function (q, r) {
      ...
      Cc = function (g, h, n, k, l) {
        return e
          .get(g)
          .xRead(
            g,
            y.subarray(h, h + n),
            4294967296 * l + k + (0 > k ? 2 ** 32 : 0)
          );
      };
      Hc = function (g, h, n, k, l) {
        return e
          .get(g)
          .xWrite(
            g,
      ...
      Fc = function (g, h, n) {
        return e
          .get(g)
          .xTruncate(g, 4294967296 * n + h + (0 > h ? 2 ** 32 : 0));
      };
      Ec = function (g, h) {
      ...
      uc = function (g, h) {
        const n = e.get(g);
        h = b("Int32", h);
        return n.xCheckReservedLock(g, h);
      };
      yc = function (g, h, n) {
        const k = e.get(g);
        n = new DataView(y.buffer, n);
        return k.xFileControl(g, h, n);
      };
      Dc = function (g) {
      ...
      Bc = function (g, h, n, k, l) {
        ...
        l = b("Int32", l);
        return g.xOpen(p, n, k, l);
      };
      wc = function (g, h, n) {
        return d.get(g).xDelete(x(h), n);
      };
      tc = function (g, h, n, k) {
        g = d.get(g);
        k = b("Int32", k);
        return g.xAccess(x(h), n, k);
      };
    })();
    var ld = {
      a: function (b, c, d, e) {
        u(
          "Assertion failed: " +
            x(b) +
            ", at: " +
            [c ? x(c) : "unknown filename", d, e ? x(e) : "unknown function"]
        );
      },
      L: function (b, c) {
        try {
          return (b = x(b)), zb(b, c), 0;
        } catch (d) {
          if ("undefined" == typeof U || !(d instanceof O)) throw d;
          return -d.Pf;
        }
      },
      Q: function (b, c, d) {
        try {
          ...
          if ("undefined" == typeof U || !(f instanceof O)) throw f;
          return -f.Pf;
        }
      },
      M: function (b, c) {
        try {
          ...
          if ("undefined" == typeof U || !(e instanceof O)) throw e;
          return -e.Pf;
        }
      },
      K: function (b) {
        try {
          ...
          if (!c) throw new O(8);
          var d = c.node;
          var e = "string" == typeof d ? S(d, { Zf: !0 }).node : d;
          if (!e.Mf.Rf) throw new O(63);
          e.Mf.Rf(e, { timestamp: Date.now() });
          return 0;
        } catch (f) {
          if ("undefined" == typeof U || !(f instanceof O)) throw f;
          return -f.Pf;
        ...
        try {
          ...
          switch (c) {
            ...
            case 3:
              return e.flags;
            case 4:
              return (f = Mb()), (e.flags |= f), 0;
            case 5:
              return (f = Mb()), (B[(f + 0) >> 1] = 2), 0;
            case 6:
            case 7:
              return 0;
            case 16:
          ...
          if ("undefined" == typeof U || !(g instanceof O)) throw g;
          return -g.Pf;
        }
      },
      J: function (b, c) {
      ...
      u: function (b, c, d, e) {
        try {
          ...
          if ("undefined" == typeof U || !(n instanceof O)) throw n;
          return -n.Pf;
        }
      },
      t: function (b) {
        try {
          ...
          if ("undefined" == typeof U || !(c instanceof O)) throw c;
          return -c.Pf;
        }
      },
      H: function (b, c) {
        try {
          return (b = x(b)), Kb(xb, b, c);
        } catch (d) {
          if ("undefined" == typeof U || !(d instanceof O)) throw d;
          return -d.Pf;
        }
        ...
        try {
          ...
          if (0 === d) {
            ...
            var f = Na(b),
              ...
              h = ob(e, f, !1);
            if (h) throw new O(h);
            if (!e.Mf.og) throw new O(63);
            if (g.ag) throw new O(10);
            e.Mf.og(e, f);
            ib(g);
          } else 512 === d ? wb(c) : u("Invalid flags passed to unlinkat");
          return 0;
        } catch (n) {
          if ("undefined" == typeof U || !(n instanceof O)) throw n;
          return -n.Pf;
      ...
      q: function (b, c, d) {
        try {
          ...
          b = g;
          var n = S(c, { Zf: !0 }).node;
          n.Mf.Rf(n, { timestamp: Math.max(b, h) });
          return 0;
        } catch (k) {
          if ("undefined" == typeof U || !(k instanceof O)) throw k;
          return -k.Pf;
        }
      },
      N: function (b, c) {
        b = new Date(1e3 * Nb(b));
        C[c >> 2] = b.getSeconds();
        C[(c + 4) >> 2] = b.getMinutes();
        C[(c + 8) >> 2] = b.getHours();
        C[(c + 12) >> 2] = b.getDate();
        C[(c + 16) >> 2] = b.getMonth();
        C[(c + 20) >> 2] = b.getFullYear() - 1900;
        C[(c + 24) >> 2] = b.getDay();
        var d = b.getFullYear();
        C[(c + 28) >> 2] =
          ((0 !== d % 4 || (0 === d % 100 && 0 !== d % 400) ? Pb : Ob)[
            b.getMonth()
          ] +
            b.getDate() -
            1) |
          0;
        C[(c + 36) >> 2] = -(60 * b.getTimezoneOffset());
      ...
      y: function (b, c, d, e, f, g, h) {
        try {
          var n = V(e);
          if (0 !== (c & 2) && 0 === (d & 2) && 2 !== (n.flags & 2097155))
            throw new O(2);
          if (1 === (n.flags & 2097155)) throw new O(2);
          if (!n.Nf.kg) throw new O(43);
          var k = n.Nf.kg(n, b, f, c, d);
          var l = k.Qg;
          C[g >> 2] = k.Eg;
          E[h >> 2] = l;
          return 0;
        } catch (p) {
          if ("undefined" == typeof U || !(p instanceof O)) throw p;
          return -p.Pf;
        }
      },
      z: function (b, c, d, e, f, g) {
        try {
          var h = V(f);
          if (d & 2) {
            if (32768 !== (h.node.mode & 61440)) throw new O(43);
            e & 2 || (h.Nf.lg && h.Nf.lg(h, y.slice(b, b + c), g, c, e));
          }
        } catch (n) {
          if ("undefined" == typeof U || !(n instanceof O)) throw n;
          return -n.Pf;
      ...
      O: function (b, c, d) {
        ...
        var n = h.getTimezoneOffset();
        E[b >> 2] = 60 * Math.max(f, n);
        C[c >> 2] = Number(f != n);
        b = e(g);
        c = e(h);
        b = Qb(b);
      ...
      f: function (b) {
        try {
          var c = V(b);
          if (null === c.Xf) throw new O(8);
          c.pg && (c.pg = null);
          try {
            c.Nf.close && c.Nf.close(c);
          } catch (d) {
            throw d;
          } finally {
            Q[c.Xf] = null;
      ...
      v: function (b, c, d, e) {
        try {
          ...
          if ("undefined" == typeof U || !(H instanceof O)) throw H;
          return H.Pf;
        }
      },
      ...
      E: function (b) {
        try {
          var c = V(b);
          return Vc(function (d) {
            var e = c.node.Vf;
            e.type.Tg
              ? e.type.Tg(e, !1, function (f) {
                  f
                    ? d(function () {
                        return 29;
                      })
        ...
        try {
          a: {
            ...
            for (var g, h = (c = 0); h < d; h++) {
              ...
              if (16384 === (l.node.mode & 61440)) throw new O(31);
              if (!l.Nf.write) throw new O(28);
              l.seekable && l.flags & 1024 && Db(l, 0, 2);
              var z = "undefined" != typeof r;
              if (!z) r = l.position;
              else if (!l.seekable) throw new O(70);
              var G = l.Nf.write(l, w, p, q, r, void 0);
              z || (l.position += G);
              var D = G;
              if (0 > D) {
                var J = -1;
    ...
    (function () {
      ...
      function d(g) {
        return Ia()
          ...
          .then(g, function (h) {
            t("failed to asynchronously prepare wasm: " + h);
            u(h);
          });
      }
      var e = { a: ld };
      ...
      if (a.instantiateWasm)
        try {
          ...
          t("Module.instantiateWasm callback failed with error: " + g), ba(g);
        }
      (function () {
        return la ||
          ...
          ? d(c)
          : fetch(F, { credentials: "same-origin" }).then(function (g) {
              return WebAssembly.instantiateStreaming(g, e).then(
                c,
                function (h) {
                  t("wasm streaming compile failed: " + h);
    ...
    var kd = (a.___errno_location = function () {
      return (kd = a.___errno_location = a.asm.cf).apply(null, arguments);
    });
    ...
    var Rb = (a._malloc = function () {
        return (Rb = a._malloc = a.asm.qf).apply(null, arguments);
      }),
      $c = (a._free = function () {
        return ($c = a._free = a.asm.rf).apply(null, arguments);
      });
    ...
    var ab = (a._emscripten_builtin_memalign = function () {
        return (ab = a._emscripten_builtin_memalign = a.asm.Df).apply(
          null,
          arguments
        );
      }),
      md = (a.getTempRet0 = function () {
        return (md = a.getTempRet0 = a.asm.Ef).apply(null, arguments);
      }),
      hd = (a.stackSave = function () {
        return (hd = a.stackSave = a.asm.Ff).apply(null, arguments);
      }),
      fd = (a.stackRestore = function () {
        return (fd = a.stackRestore = a.asm.Gf).apply(null, arguments);
      }),
      gd = (a.stackAlloc = function () {
        return (gd = a.stackAlloc = a.asm.Hf).apply(null, arguments);
      }),
      Yc = (a._asyncify_start_unwind = function () {
        return (Yc = a._asyncify_start_unwind = a.asm.If).apply(
          null,
          arguments
        );
      }),
      Mc = (a._asyncify_stop_unwind = function () {
        return (Mc = a._asyncify_stop_unwind = a.asm.Jf).apply(null, arguments);
      }),
      Wc = (a._asyncify_start_rewind = function () {
        return (Wc = a._asyncify_start_rewind = a.asm.Kf).apply(
          null,
          arguments
        );
      }),
      Zc = (a._asyncify_stop_rewind = function () {
        return (Zc = a._asyncify_stop_rewind = a.asm.Lf).apply(null, arguments);
      });
    a._sqlite3_version = 60912;
    a.UTF8ToString = x;
    a.stringToUTF8 = qa;
    a.lengthBytesUTF8 = ra;
    a.getTempRet0 = md;
    a.ccall = Z;
    ...
    a.addFunction = function (b, c) {
      ...
      if (cd.has(b)) return cd.get(b);
      if (dd.length) d = dd.pop();
      else {
        try {
          wa.grow(1);
        } catch (n) {
    ...
    a.UTF16ToString = function (b, c) {
      var d = b >> 1;
      for (var e = d + c / 2; !(d >= e) && sa[d]; ) ++d;
      d <<= 1;
      if (32 < d - b && jd) return jd.decode(y.subarray(b, d));
      d = "";
      for (e = 0; !(e >= c / 2); ++e) {
        var f = B[(b + 2 * e) >> 1];
        if (0 == f) break;
    ...
    a.stringToUTF16 = function (b, c, d) {
      ...
      for (var f = 0; f < d; ++f) (B[c >> 1] = b.charCodeAt(f)), (c += 2);
      B[c >> 1] = 0;
      return c - e;
    };
      ...
      function b() {
        if (!nd && ((nd = !0), (a.calledRun = !0), !v)) {
          a.noFSInit ||
            ...
            (a.stdout = a.stdout),
            (a.stderr = a.stderr),
            a.stdin ? Ib("stdin", a.stdin) : vb("/dev/tty", "/dev/stdin"),
            a.stdout
              ? Ib("stdout", null, a.stdout)
              : vb("/dev/tty", "/dev/stdout"),
            a.stderr
              ? Ib("stderr", null, a.stderr)
