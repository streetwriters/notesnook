 ...
 *
 * NOT PART OF THE SHIPPING APP. Delete this file (and its two call sites) once
 * the store assets are captured. See audit/screenshot-content-spec.md on the
 * website repo for the reasoning behind the content.
 *
 * Kept byte-for-byte in step with apps/mobile/app/common/seed-demo.ts apart
