  ...
  var e = {
      804: function (e) {
        var t =
          ...
          i = /and|article|body|column|content|main|shadow/i;
        function n(e) {
          return (
        ...
        e.exports = function (e, r = {}) {
          "function" == typeof r && (r = { visibilityChecker: r }),
            (r = Object.assign(
              { minScore: 20, minContentLength: 140, visibilityChecker: n },
              r
            ));
          ...
          return [].some.call(o, function (e) {
            ...
            if ((t.test(n) && !i.test(n)) || e.matches("li p")) return !1;
            var o = e.textContent.trim().length;
            return (
              !(o < r.minContentLength) &&
              (s += Math.sqrt(o - r.minContentLength)) > r.minScore
            );
          });
        };
      },
      238: function (e) {
        function t(e, t) {
          ...
          if (
            ...
            (this._charThreshold =
              t.charThreshold || this.DEFAULT_CHAR_THRESHOLD),
            ...
            (this._allowedVideoRegex =
              t.allowedVideoRegex || this.REGEXPS.videos),
            (this._flags =
            ...
            this.log = function () {
              if ("undefined" != typeof console) {
                let t = Array.from(arguments, (t) =>
                  t && t.nodeType == this.ELEMENT_NODE ? e(t) : t
                );
                t.unshift("Reader: (Readability)"),
        ...
        (t.prototype = {
          ...
          _fixRelativeUris: function (e) {
              ...
              if (t)
                if (0 === t.indexOf("javascript:"))
                  if (
                    ...
                    for (
                      var r = this._doc.createElement("span");
                      e.firstChild;
            ...
            var o = this._getAllNodesWithTag(e, [
              "img",
              "picture",
              "figure",
              "video",
            ...
            for (var t = e; t; ) {
              if (
                ...
                if (this._isElementWithoutContent(t)) {
                  ...
                  for (
                    var i = t.children[0], n = 0;
                    n < t.attributes.length;
                    n++
                  )
                    i.setAttribute(t.attributes[n].name, t.attributes[n].value);
          ...
          _getArticleTitle: function () {
            ...
            try {
              (t = i = e.title.trim()),
                "string" != typeof t &&
                  (t = i =
                    this._getInnerText(e.getElementsByTagName("title")[0]));
            } catch (e) {}
            var n = !1;
            function r(e) {
            ...
            if (/ [\|\-\\\/>»] /.test(t))
              (n = / [\\\/>»] /.test(t)),
                3 > r((t = i.replace(/(.*)[\|\-\\\/>»] .*/gi, "$1"))) &&
                  (t = i.replace(/[^\|\-\\\/>»]*[\|\-\\\/>»](.*)/gi, "$1"));
            else if (-1 !== t.indexOf(": ")) {
              var o = this._concatNodeLists(
              ...
              !this._someNode(o, function (e) {
                ...
                (3 > r((t = i.substring(i.lastIndexOf(":") + 1)))
            ...
            var s = r((t = t.trim().replace(this.REGEXPS.normalize, " ")));
            return (
              s <= 4 &&
                (!n || s != r(i.replace(/[\|\-\\\/>»]+/g, "")) - 1) &&
                (t = i),
          ...
          _prepDocument: function () {
            ...
            this._removeNodes(this._getAllNodesWithTag(e, ["style"])),
              ...
              this._replaceNodeTags(
                this._getAllNodesWithTag(e, ["font"]),
                "SPAN"
              );
          },
            ...
            this._forEachNode(
              ...
              function (e) {
                ...
                if (i) {
                  ...
                  for (
                    e.parentNode.replaceChild(r, e), t = r.nextSibling;
                    t;
                  ...
                  "P" === r.parentNode.tagName &&
                    this._setNodeTag(r.parentNode, "DIV");
                }
              }
            );
          },
          ...
          _prepArticle: function (e) {
            ...
            this._forEachNode(e.children, function (e) {
              this._cleanMatchedNodes(e, function (e, i) {
                return (
                  this.REGEXPS.shareElements.test(i) && e.textContent.length < t
                );
              });
            }),
              ...
              this._forEachNode(
                this._getAllNodesWithTag(e, ["table"]),
                function (e) {
          ...
          _textSimilarity: function (e, t) {
            ...
            return i.length && n.length
              ? 1 -
                  n.filter((e) => !i.includes(e)).join(" ").length /
                    n.join(" ").length
              : 0;
          },
          ...
          _getNodeAncestors: function (e, t) {
            ...
            for (
              var i = 0, n = [];
              e.parentNode && (n.push(e.parentNode), !t || ++i !== t);
          ...
          _grabArticle: function (e) {
            ...
            for (var n = e.innerHTML; ; ) {
              ...
              var r,
                o = this._flagIsActive(this.FLAG_STRIP_UNLIKELYS),
                a = [],
              ...
              for (; l; ) {
                ...
                if (
                  ("true" == l.getAttribute("aria-modal") &&
                    "dialog" == l.getAttribute("role")) ||
                  this._checkByline(l, s)
                ) {
                  l = this._removeAndGetNext(l);
                  continue;
                }
                if ($ && this._headerDuplicatesTitle(l)) {
                  this.log(
                    "Removing header: ",
                    l.textContent.trim(),
                ...
                if (
                  (-1 !== this.DEFAULT_TAGS_TO_SCORE.indexOf(l.tagName) &&
                    a.push(l),
                  "DIV" === l.tagName)
                ) {
                  ...
                  if (
                    ...
                    0.25 > this._getLinkDensity(l)
                  ) {
                    var u = l.children[0];
                    l.parentNode.replaceChild(u, l), (l = u), a.push(l);
                  } else
                  ...
                  if (!(i.length < 25)) {
                    ...
                    0 !== n.length &&
                      ((t =
                        1 +
                        i.split(",").length +
                        Math.min(Math.floor(i.length / 100), 3)),
                      this._forEachNode(n, function (e, i) {
                        if (
                          e.tagName &&
                          e.parentNode &&
                          ...
                          if (
                            (void 0 === e.readability &&
                              (this._initializeNode(e), f.push(e)),
                            0 === i)
                          )
                            var n = 1;
                          else n = 1 === i ? 2 : 3 * i;
                          e.readability.contentScore += t / n;
                        }
                      }));
                  }
                }
              });
              for (var g = [], m = 0, p = f.length; m < p; m += 1) {
                var _ = f[m],
                  y =
                    _.readability.contentScore * (1 - this._getLinkDensity(_));
                (_.readability.contentScore = y),
                  this.log("Candidate:", _, "with score " + y);
                for (var v = 0; v < this._nbTopCandidates; v++) {
                  var E = g[v];
                  if (!E || y > E.readability.contentScore) {
                    g.splice(v, 0, _),
                      g.length > this._nbTopCandidates && g.pop();
                    break;
                  }
                }
              }
              ...
              if (null === b || "BODY" === b.tagName) {
                for (b = t.createElement("DIV"), N = !0; e.firstChild; )
                  this.log("Moving child out:", e.firstChild),
                    b.appendChild(e.firstChild);
                e.appendChild(b), this._initializeNode(b);
              } else if (b) {
                for (var T = [], A = 1; A < g.length; A++)
                  g[A].readability.contentScore / b.readability.contentScore >=
                    0.75 && T.push(this._getNodeAncestors(g[A]));
                if (T.length >= 3)
                  for (r = b.parentNode; "BODY" !== r.tagName; ) {
                    for (var S = 0, C = 0; C < T.length && S < 3; C++)
                      S += Number(T[C].includes(r));
                    if (S >= 3) {
                      b = r;
                      break;
                    }
                ...
                b.readability || this._initializeNode(b), (r = b.parentNode);
                for (
                  var L = b.readability.contentScore, x = L / 3;
                  "BODY" !== r.tagName;
                  ...
                  var w = r.readability.contentScore;
                  if (w < x) break;
                  if (w > L) {
                    b = r;
                    break;
                ...
                for (
                  r = b.parentNode;
                  "BODY" != r.tagName && 1 == r.children.length;
              ...
              for (
                var R = Math.max(10, 0.2 * b.readability.contentScore),
                  I = (r = b.parentNode).children,
                  P = 0,
                  D = I.length;
                P < D;
                P++
                ...
                if (
                  (this.log(
                    ...
                    M,
                    M.readability
                      ? "with score " + M.readability.contentScore
                      : ""
                  ),
                  this.log(
                    "Sibling has score",
                    M.readability ? M.readability.contentScore : "Unknown"
                  ),
                  M === b)
                )
                  B = !0;
                  ...
                  if (
                    (M.className === b.className &&
                      "" !== b.className &&
                      (H += 0.2 * b.readability.contentScore),
                    M.readability && M.readability.contentScore + H >= R)
                  )
                    B = !0;
                  else if ("P" === M.nodeName) {
                    var k = this._getLinkDensity(M),
                ...
                B &&
                  ...
                  -1 === this.ALTER_TO_DIV_EXCEPTIONS.indexOf(M.nodeName) &&
                    (this.log("Altering sibling:", M, "to div."),
                    (M = this._setNodeTag(M, "DIV"))),
                  O.appendChild(M),
                  (I = r.children),
                  (P -= 1),
                  (D -= 1));
              ...
              if (
                (this._debug &&
                  this.log("Article content pre-prep: " + O.innerHTML),
                this._prepArticle(O),
                this._debug &&
                  this.log("Article content post-prep: " + O.innerHTML),
                N)
              )
              ...
              this._debug &&
                this.log("Article content after paging: " + O.innerHTML);
              var W = !0,
                V = this._getInnerText(O, !0).length;
              if (V < this._charThreshold)
                if (
                  ...
                  this._removeFlag(this.FLAG_STRIP_UNLIKELYS),
                    this._attempts.push({ articleContent: O, textLength: V });
                  ...
                  if (
                    ...
                    return null;
                  (O = this._attempts[0].articleContent), (W = !0);
                }
              if (W) {
                var F = [r, b].concat(this._getNodeAncestors(r));
                return (
                  this._someNode(F, function (e) {
                  ...
                  try {
                    ...
                    if (
                      ...
                      "string" == typeof n.name &&
                        "string" == typeof n.headline &&
                        n.name !== n.headline)
                    ) {
                      var r = this._getArticleTitle(),
                        o = this._textSimilarity(n.name, r) > 0.75;
                      this._textSimilarity(n.headline, r) > 0.75 && !o
                        ? (t.title = n.headline)
                        : (t.title = n.name);
                    } else
                      "string" == typeof n.name
                        ? (t.title = n.name.trim())
                        : "string" == typeof n.headline &&
                          (t.title = n.headline.trim());
                    n.author &&
                      ("string" == typeof n.author.name
                        ? (t.byline = n.author.name.trim())
                        : Array.isArray(n.author) &&
                          n.author[0] &&
                          "string" == typeof n.author[0].name &&
                          (t.byline = n.author
                            .filter(function (e) {
                      ...
                      "string" == typeof n.description &&
                        (t.excerpt = n.description.trim()),
                      n.publisher &&
                        "string" == typeof n.publisher.name &&
                        (t.siteName = n.publisher.name.trim());
                    return;
                  } catch (e) {
                    this.log(e.message);
                  }
            ...
            return (
              this._forEachNode(n, function (e) {
                ...
                if (a) {
                  ...
                  n &&
                    (l = n.match(r)) &&
                    (i[(s = l[0].toLowerCase().replace(/\s/g, ""))] = a.trim()),
                    !l &&
                      t &&
                      o.test(t) &&
                      ((s = t),
              ...
              (t.byline =
                e.byline || i["dc:creator"] || i["dcterm:creator"] || i.author),
              (t.excerpt =
                e.excerpt ||
                i["dc:description"] ||
            ...
            this._forEachNode(i, function (t) {
              ...
              if (((i.innerHTML = t.innerHTML), this._isSingleImage(i))) {
                ...
                if (n && this._isSingleImage(n)) {
                  ...
                  for (
                    var o = i.getElementsByTagName("img")[0], a = 0;
                    ...
                    if (
                      ...
                      var s = l.name;
                      o.hasAttribute(s) && (s = "data-old-" + s),
                        o.setAttribute(s, l.value);
                    }
                  }
          ...
          _removeScripts: function (e) {
            this._removeNodes(
              this._getAllNodesWithTag(e, ["script", "noscript"])
            );
          },
          ...
          _hasChildBlockElement: function (e) {
            return this._someNode(e.childNodes, function (e) {
              return (
                this.DIV_TO_P_ELEMS.has(e.tagName) ||
          ...
          _getLinkDensity: function (e) {
            ...
            return (
              this._forEachNode(e.getElementsByTagName("a"), function (e) {
                var t = e.getAttribute("href"),
                  n = t && this.REGEXPS.hashUrl.test(t) ? 0.3 : 1;
          ...
          _clean: function (e, t) {
            ...
            this._removeNodes(this._getAllNodesWithTag(e, [t]), function (e) {
              if (i) {
                for (var t = 0; t < e.attributes.length; t++)
                  if (this._allowedVideoRegex.test(e.attributes[t].value))
                    return !1;
                if (
                  "object" === e.tagName &&
                  this._allowedVideoRegex.test(e.innerHTML)
                )
                  return !1;
              }
              return !0;
          ...
          _hasAncestorTag: function (e, t, i, n) {
            ...
            for (var r = 0; e.parentNode && (!(i > 0) || !(r > i)); ) {
              if (e.parentNode.tagName === t && (!n || n(e.parentNode)))
                return !0;
              (e = e.parentNode), r++;
            }
            return !1;
          ...
          _getRowAndColumnCount: function (e) {
            for (
              var t = 0, i = 0, n = e.getElementsByTagName("tr"), r = 0;
              r < n.length;
              r++
            ) {
              ...
              for (
                var a = 0, l = n[r].getElementsByTagName("td"), s = 0;
                s < l.length;
                s++
              ) {
                var c = l[s].getAttribute("colspan") || 0;
          ...
          _markDataTables: function (e) {
            for (
              var t = e.getElementsByTagName("table"), i = 0;
              i < t.length;
              i++
            ) {
              var n = t[i];
              ...
              if (n.getElementsByTagName("table")[0]) {
                n._readabilityDataTable = !1;
                continue;
              }
              ...
              n._readabilityDataTable = o.rows * o.columns > 10;
            }
          },
            ...
            this._forEachNode(
              ...
              function (e) {
                if (e.src && this.REGEXPS.b64DataUrl.test(e.src)) {
                  if (
                    "image/svg+xml" === this.REGEXPS.b64DataUrl.exec(e.src)[1]
                  )
                    return;
                  for (var t = !1, i = 0; i < e.attributes.length; i++) {
                    ...
                    if (
                      "src" !== n.name &&
                      /\.(jpg|jpeg|png|webp)/i.test(n.value)
                    ) {
                      t = !0;
                      break;
                    }
                    ...
                    if (
                      ...
                      if (
                        ...
                        if ("IMG" === e.tagName || "PICTURE" === e.tagName)
                          ...
                          l.setAttribute(a, n.value), e.appendChild(l);
                        }
                      }
                    }
                }
          ...
          _getTextDensity: function (e, t) {
            ...
            return (
              this._forEachNode(
                r,
                (e) => (n += this._getInnerText(e, !0).length)
              ),
              n / i
            );
          },
            ...
            this._flagIsActive(this.FLAG_CLEAN_CONDITIONALLY) &&
              this._removeNodes(this._getAllNodesWithTag(e, [t]), function (e) {
                ...
                if (!n) {
                  ...
                  this._forEachNode(
                    o,
                    (e) => (r += this._getInnerText(e).length)
                  ),
                    (n = r / this._getInnerText(e).length > 0.9);
                }
                if (
                  ("table" === t && i(e)) ||
                  this._hasAncestorTag(e, "table", -1, i) ||
                  this._hasAncestorTag(e, "code")
                )
                  return !1;
                var a = this._getClassWeight(e);
                if ((this.log("Cleaning Conditionally", e), a + 0 < 0))
                  return !0;
                if (10 > this._getCharCount(e, ",")) {
                  for (
                    var l = e.getElementsByTagName("p").length,
                      s = e.getElementsByTagName("img").length,
                      c = e.getElementsByTagName("li").length - 100,
                      d = e.getElementsByTagName("input").length,
                      h = this._getTextDensity(e, [
                        "h1",
                        "h2",
                        "h3",
                        "h4",
                    ...
                    for (var m = 0; m < f[g].attributes.length; m++)
                      if (
                        this._allowedVideoRegex.test(f[g].attributes[m].value)
                      )
                        return !1;
                    if (
                      "object" === f[g].tagName &&
                      this._allowedVideoRegex.test(f[g].innerHTML)
                    )
                      return !1;
                    u++;
                  }
                  var p = this._getLinkDensity(e),
                    _ = this._getInnerText(e).length,
                    y =
                      (s > 1 &&
                        l / s < 0.5 &&
                  ...
                  if (n && y) {
                    for (var v = 0; v < e.children.length; v++)
                      if (e.children[v].children.length > 1) return y;
          ...
          _cleanMatchedNodes: function (e, t) {
            for (
              var i = this._getNextNode(e, !0), n = this._getNextNode(e);
              n && n != i;

            )
              n = t.call(this, n, n.className + " " + n.id)
                ? this._removeAndGetNext(n)
                : this._getNextNode(n);
          },
          _cleanHeaders: function (e) {
            ...
            this._removeNodes(t, function (e) {
              ...
              return (
                t && this.log("Removing header with low class weight:", e), t
              );
            });
          },
      ...
      396: function (e, t, i) {
        e.exports = { Readability: i(238), isProbablyReaderable: i(804) };
      },
      900: function (e, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.cloneNode = function (e, t) {
            let n = (e = e.cloneNode(!0)).querySelectorAll("img");
            if (t.images) for (let e of n) e.src = e.currentSrc;
            ...
            if (!t.styles)
              for (let t of e.querySelectorAll(
                ...
                t.remove();
            for (let t of e.querySelectorAll(i.join(","))) t.remove();
            return e;
          });
        let i = ["script", "noscript"];
      },
      399: function (e, t, i) {
        "use strict";
        var n =
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.toJpeg = function (e, t, i) {
            return n(this, void 0, void 0, function* () {
              return (
                (i.raster = !0),
                d(e, t, i).then((e) =>
                  null == e ? void 0 : e.toDataURL("image/jpeg", i.quality || 1)
                )
              );
            });
          }),
          (t.toBlob = function (e, t, i) {
            return (
              (i.raster = !0),
              d(e, t, i).then((e) => e && (0, l.canvasToBlob)(e))
            );
          }),
          (t.toPng = function (e, t, i) {
            return (
              (i.raster = !0),
              d(e, t, i).then(function (e) {
                return null == e ? void 0 : e.toDataURL();
              })
            );
          }),
          (t.toSvg = function (e, t, i) {
            return h(
              e,
              t,
              i.width || (0, l.width)(e),
              i.height || (0, l.height)(e)
            );
          }),
          (t.getInlinedNode = function (e, t) {
            return n(this, void 0, void 0, function* () {
              let {
                  fonts: i,
                  images: n,
                ...
                d = (0, s.cloneNode)(e, { images: n, styles: r });
              if (!(!d || d instanceof Text)) {
                var h, u;
                return (
                  i &&
                    (d = yield ((h = d),
                    (u = t.fetchOptions),
                    (0, o.resolveAll)(u).then(function (e) {
                  ...
                  c && (yield (0, a.inlineAllImages)(d, t.fetchOptions)),
                  (function (e) {
                    for (let t of e.querySelectorAll("*"))
                      !(
                        !(t instanceof HTMLElement) || (0, l.isSVGElement)(t)
                      ) &&
                        t instanceof HTMLAnchorElement &&
                        (t.href = t.href.startsWith("http")
                          ? t.href
                          : document.location.origin + t.href);
                  })(d),
                  d
                );
              }
            ...
            let n =
              ...
              encodeURIComponent(
                h(
                  e,
                  t,
                  (i = Object.assign(Object.assign({}, c), i)).width ||
                    (0, l.width)(e),
                  i.height || (0, l.height)(e)
                )
              );
            return (0, r.createImage)(n, i.fetchOptions)
              .then((0, l.delay)(0))
              .then(function (t) {
                if (!t) return null;
                t.setAttribute("crossorigin", "anonymous");
                let n = "number" != typeof i.scale ? 1 : i.scale,
                  r = (function (e, t, i) {
                    let n = document.createElement("canvas");
                    if (
                      ((n.width = (i.width || (0, l.width)(e)) * t),
                      (n.height = (i.height || (0, l.height)(e)) * t),
                      i.backgroundColor)
                    ) {
        ...
        function h(e, t, i, n) {
          for (let t of (e.setAttribute(
            "xmlns",
            "http://www.w3.org/1999/xhtml"
          ),
          e.querySelectorAll("img, svg, video, iframe")))
            for (let e of t.getAttributeNames())
              e.match(/\W/) && t.removeAttribute(e);
          ...
          return (
            ...
            n +
            '">' +
            Array.from(t.getElementsByTagName("style"))
      ...
      113: function (e, t) {
        ...
        function n(e, t) {
          ...
          if (
            ((null == t ? void 0 : t.noCache) &&
              (e += (/\?/.test(e) ? "&" : "?") + Date.now()),
            (null == t ? void 0 : t.bypassCors) &&
              (null == t ? void 0 : t.corsHost))
          ) {
            if (e.startsWith(t.corsHost)) return e;
            e = `${t.corsHost}/${e}`;
          }
          return e;
        }
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.fetchResource = function (e, t) {
            return i(this, void 0, void 0, function* () {
              if (!e) return null;
              let i = yield fetch(n(e, t));
              if (!i.ok) return "";
              let r = yield i.blob(),
                o = new FileReader();
              return (
                ...
                new Promise((e) => {
                  o.addEventListener("loadend", () => {
                    "string" == typeof o.result && e(o.result);
                  });
                })
              );
            });
          }),
          (t.createImage = function (e, t) {
            return "data:," === e
              ? Promise.resolve(null)
              : new Promise(function (i, r) {
                  let o = new Image();
                  (o.crossOrigin =
                    (null == t ? void 0 : t.crossOrigin) || null),
                    (o.onload = function () {
                      i(o);
                    }),
                    (o.onerror = () => r(Error("Failed to render image."))),
                    (o.src = n(e, t));
                });
          }),
          (t.reloadImage = function (e, t) {
            return t.corsHost && e.currentSrc.startsWith(t.corsHost)
              ? Promise.resolve(null)
              : ((t.noCache = !0),
                new Promise(function (i, r) {
                  (e.crossOrigin = t.crossOrigin || null),
                    (e.onload = function () {
                      i(e);
                    }),
                    (e.onerror = (t) => {
                      console.error("Failed to load image", e.currentSrc), r(t);
                    }),
                    (e.src = n(e.currentSrc, t));
                }));
          }),
          (t.constructUrl = n);
      },
      536: function (e, t, i) {
            ...
            return n(this, void 0, void 0, function* () {
              let t = a(
                  (function (e) {
                    ...
                    for (let i of e)
                      try {
                        let e = a(Array.from(i.cssRules));
                        e.length > 3 && t.push(e[0]);
                      } catch (e) {
                        e instanceof Error &&
                          console.log(
                            "Error while reading CSS rules from " + i.href,
                            e.toString()
                          );
                      }
                    return t;
                ...
                i = [];
              for (let n of t) i.push(yield n.resolve(e));
              return i.join("\n");
            });
          });
        let r = i(812);
        function o(e) {
          return {
            resolve: function (t) {
              let i = (e.parentStyleSheet || {}).href || void 0;
              return (0, r.inlineAll)(e.cssText, t, i);
            },
            src: function () {
        ...
        function a(e) {
          return e
            ...
            .filter(function (e) {
              return (0, r.shouldProcess)(e.style.getPropertyValue("src"));
            });
        }
      },
      307: function (e, t, i) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.inlineAllImages = function (e, t) {
            return n(this, void 0, void 0, function* () {
              ...
              for (let e = 0; e < i.length; ++e) {
                ...
                a.push(
                  (function (e, t) {
                    return n(this, void 0, void 0, function* () {
                      var i, n;
                      if ((0, o.isDataUrl)(e.currentSrc))
                        return Promise.resolve(null);
                      let a = yield (0, r.fetchResource)(
                        e.currentSrc || e.src,
                        t
                      );
                      return a
                        ? "data:," === a
                          ? (e.removeAttribute("src"), e)
                          : void ((null == (i = e.parentElement)
                              ? void 0
                              : i.tagName) === "PICTURE" &&
              ...
              yield Promise.allSettled(a).catch((e) => console.error(e));
            });
          });
        let r = i(113),
          o = i(132);
      ...
      769: function (e, t, i) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.clipPage = function (e, t, i) {
            return n(this, void 0, void 0, function* () {
              let { body: n, head: r } = yield E(e, i, t);
              if (!n || !r) return null;
              let o = y(r, n).documentElement.outerHTML;
              return `<!doctype html>
${o}`;
            });
          }),
          (t.clipArticle = function (e, t) {
            return n(this, void 0, void 0, function* () {
              let { body: i, head: n } = yield E(e, t);
              if (!i || !n) return null;
              let o = y(n, i),
                a = new r.Readability(o);
              a.PRESENTATIONAL_ATTRIBUTES = [
                "align",
                "background",
                "bgcolor",
                "border",
              ...
              }<body>${(null == l ? void 0 : l.content) || ""}</body></html>`;
            });
          }),
          (t.cleanup = v),
          (t.clipScreenshot = function (e) {
            return n(this, arguments, void 0, function* (e, t = "jpeg", i) {
              let n = b(i),
                { body: r, head: o } = yield E(document, i, !1);
              if (!r || !o) return null;
              let a =
                  "jpeg" === t
                    ? l.toJpeg
              ...
              return "jpeg" === t || "png" === t
                ? `<img width="${document.body.scrollWidth}px" height="${document.body.scrollHeight}px" src="${s}" />`
                : s;
            });
          }),
          (t.enterNodeSelectionMode = function (e, t) {
            let i;
            return (
              setTimeout(() => {
                e.body.addEventListener("click", _),
                  e.body.addEventListener("mouseout", p),
                  e.body.addEventListener("mouseover", m);
              }, 0),
              (i = `.${c} {
  ...
  .${h} {
    ...
    z-index: ${Number.MAX_VALUE};
              ...
              (0, o.injectCss)(i, "nn-clipper-styles"),
              new Promise((e, i) => {
                var r, o;
                let s;
                (r = () =>
                  n(this, void 0, void 0, function* () {
                    v();
                    let i = document.querySelectorAll(`.${d}`),
                      { head: n } = yield E(document, t, !1),
                      r = document.createElement("html");
                    r.append(n);
                    let o = document.createElement("body");
                    for (let e of (r.append(o), i)) {
                      e.classList.remove(d);
                      let i = yield (0, l.getInlinedNode)(e, {
                        raster: !1,
                        fetchOptions: b(t),
                        inlineOptions: Object.assign(Object.assign({}, f), {
                          images: null == t ? void 0 : t.images,
                          inlineImages: null == t ? void 0 : t.inlineImages
                        })
                      });
                      i && o.appendChild(i);
                    }
                    e(null == r ? void 0 : r.outerHTML);
                  })),
                  (o = () => i("Cancelled.")),
                  (s = document.createElement("div")).classList.add(h),
                  setTimeout(() => {
                      ...
                      (0, a.h)(
                        ...
                        [
                          (0, a.h)(
                            ...
                            [(0, a.text)("Notesnook Web Clipper")]
                          ),
                          (0, a.h)(
                            "p",
                            {
                            ...
                            [
                              e
                                ? (0, a.text)(
                                    "Clipping selected elements. Please wait..."
                                  )
                                : (0, a.text)(
        ...
        let r = i(396),
          ...
          l = i(399),
          s = i(707),
          c = "nn-node-selection--hover",
          d = "nn-node-selection--selected",
          h = "nn-node-selection-container",
          u = [d, h],
          f = { fonts: !1, images: !1, stylesheets: !0 };
        function g(e) {
          for (let t of u)
            if (e.classList.contains(t) || e.closest(`.${t}`)) return !1;
          return !0;
        }
        let m = (e) => {
            let t = e.target;
            !t.classList.contains(c) && g(t) && t.classList.add(c);
          },
          p = (e) => {
            let t = e.target;
          ...
          _ = (e) => {
            ...
            t.classList.contains(d)
              ...
              : g(t) && t.classList.add(d);
          };
        function y(e, t) {
          let i = document.implementation.createHTMLDocument();
          return i.documentElement.replaceChildren(e, t), i;
        }
        function v() {
          setTimeout(() => {
            var e;
            document.querySelectorAll(`.${d}`).forEach((e) => {
              e instanceof HTMLElement && e.classList.remove(d);
            }),
              document.querySelectorAll(`.${h}`).forEach((e) => e.remove()),
              (e = document).body.removeEventListener("mouseout", p),
              e.body.removeEventListener("mouseover", m),
              document.body.removeEventListener("click", _);
          }, 0);
        }
        function E(e, t) {
          return n(this, arguments, void 0, function* (e, t, i = !1) {
            let n = b(t),
              r = yield (0, l.getInlinedNode)(e.body, {
                raster: !0,
                fetchOptions: n,
                inlineOptions: {
                  fonts: !1,
                  inlineImages: null == t ? void 0 : t.inlineImages,
                  images: null == t ? void 0 : t.images,
                  stylesheets: null == t ? void 0 : t.styles
                },
                filter: (e) => {
                  var t;
                  let n, r, o, a, l, s, c, d, h, u, f, g, m, p, _, y;
                  return (
                    !i ||
                    (((t = e).nodeType === Node.TEXT_NODE ||
                      !t.getBoundingClientRect) &&
                      t.parentElement &&
                      (t = t.parentElement),
                    ((n = {
                      isInViewport: !1,
                      isPartiallyInViewport: !1,
                      isInsideViewport: !1,
                      isAroundViewport: !1,
                      isOnEdge: !1,
                      isOnTopEdge: !1,
                    ...
                    (l = r.left >= 0 && r.left + r.width <= a),
                    (s = r.top >= 0 && r.top + r.height <= o),
                    (n.isInsideViewport = l && s),
                    (c = r.left < 0 && r.left + r.width > a),
                    (d = r.top < 0 && r.top + r.height > o),
                    (n.isAroundViewport = c && d),
                    (h = r.top < 0 && r.top + r.height > 0),
                    (u = r.left < a && r.left + r.width > a),
                    (f = r.left < 0 && r.left + r.width > 0),
                    (g = r.top < o && r.top + r.height > o),
                    (m = s || d || h || g),
                    (p = l || c || f || u),
                    (n.isOnTopEdge = h && p),
                    (n.isOnRightEdge = u && m),
                    (n.isOnBottomEdge = g && p),
                    (n.isOnLeftEdge = f && m),
                    (n.isOnEdge =
                      n.isOnLeftEdge ||
                      n.isOnRightEdge ||
                      n.isOnTopEdge ||
                      n.isOnBottomEdge),
                    (_ = l || c || n.isOnLeftEdge || n.isOnRightEdge),
                    (y = s || d || n.isOnTopEdge || n.isOnBottomEdge),
                    (n.isInViewport = _ && y),
                    (n.isPartiallyInViewport = n.isInViewport && n.isOnEdge),
                    n).isInViewport)
                  );
                }
              });
            if (!r) return {};
            let o = e.createElement("head"),
              a = e.createElement("title");
            for (let [i, l] of ((a.innerText = e.title),
            o.appendChild(a),
            (null == t ? void 0 : t.styles) &&
              (yield (0, s.addStylesToHead)(o, n)),
            Object.entries(
              (function (e) {
                let t = {};
                for (let { name: i } of e.attributes) {
              ...
              r.setAttribute(i, l);
            return { body: r, head: o };
          });
        }
        function b(e) {
          return (null == e ? void 0 : e.corsProxy)
            ? {
                bypassCors: !0,
                corsHost: e.corsProxy,
      ...
      812: function (e, t, i) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.shouldProcess = l),
          (t.inlineAll = function (e, t, i, a) {
            return n(this, void 0, void 0, function* () {
              if (!l(e)) return e;
              for (let l of s(e))
                e = yield (function (e, t, i, a, l) {
                  return n(this, void 0, void 0, function* () {
                    let n = a ? (0, o.resolveUrl)(t, a) : t,
                      s = l
                        ? (0, r.constructUrl)(n, i)
                        : yield (0, r.fetchResource)(n, i).catch(() =>
                            (0, r.constructUrl)(n, i)
                          );
                    return e.replace(t, s || n);
                  });
                })(e, l, t, i, a).catch((t) => (console.error(t), e));
              return e;
            });
          }),
          (t.readUrls = s);
        ...
        function s(e) {
          let t,
            i = [];
          for (; null !== (t = a.exec(e)); ) i.push(t[1]);
          return i.filter(function (e) {
            return !(0, o.isDataUrl)(e);
          });
        }
      },
      707: function (e, t, i) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.addStylesToHead = function (e, t) {
            return n(this, void 0, void 0, function* () {
              for (let i of (yield (function (e) {
                return n(this, void 0, void 0, function* () {
                  for (let t of document.styleSheets) {
                    ...
                    if (
                      !(yield (function (e, t) {
                        return n(this, void 0, void 0, function* () {
                          try {
                            ...
                            let i = e.ownerNode;
                            if (e.href && i instanceof HTMLLinkElement) {
                              if (l(i)) return !0;
                              let e = yield a(i.href, t);
                              e && i.replaceWith(e);
                            }
                            return !0;
                          }
                      ...
                      for (let n = 0; n < t.cssRules.length; ++n) {
                        let r = t.cssRules.item(n);
                        if (r && r.type === CSSRule.IMPORT_RULE) {
                          let o = r.href,
                            l = yield a(o, e);
                          l &&
                            (t.ownerNode
                              ? t.ownerNode.before(l)
                              : document.head.appendChild(l),
                            i.push(n));
                        }
                      }
                      if (0 !== t.cssRules.length)
                        for (let e of i) t.deleteRule(e);
                    }
                  }
                });
              })(t),
              document.styleSheets)) {
                if (l(i)) continue;
                let n =
                  i.href && i.ownerNode instanceof HTMLLinkElement
                    ? i.ownerNode.href
                    : i.ownerNode instanceof HTMLStyleElement
                    ? i.ownerNode.getAttribute("href")
                    : null;
                if (n) {
                  let i = yield a(n, t);
                  if (!i) continue;
                  let r = new CSSStyleSheet();
                  yield r.replace(i.innerHTML), yield c(r, t);
                  let o = s(r.cssRules);
                  e.appendChild(o);
                  continue;
                }
                if (i.cssRules.length > 0) {
                  yield c(i, t);
                  let n = s(i.cssRules);
                  e.appendChild(n);
                  continue;
                }
                if (i.ownerNode instanceof HTMLStyleElement) {
                  e.appendChild(i.ownerNode.cloneNode(!0));
                  continue;
                }
              }
            });
          ...
          return n(this, void 0, void 0, function* () {
            try {
              let i = document.createElement("style"),
                n = yield fetch((0, r.constructUrl)(e, t));
              if (!n.ok) return !1;
              return (
                (i.innerHTML = yield n.text()), i.setAttribute("href", e), i
              );
            } catch (t) {
              console.error("Failed to inline stylesheet", e, t);
            }
          });
        }
        function l(e) {
          return ("string" == typeof e.media ? e.media : e.media.mediaText)
            .split(",")
            .map((e) => e.trim())
            .includes("print");
        }
        ...
        function c(e, t) {
          return n(this, void 0, void 0, function* () {
            ...
            for (let n of e.cssRules)
              if (n.type === CSSRule.STYLE_RULE) i.push(d(e, n, t));
              else if (n.type === CSSRule.MEDIA_RULE) {
                let r = window.matchMedia(n.media.mediaText).matches;
                for (let o of n.cssRules)
                  o && o.type === CSSRule.STYLE_RULE && i.push(d(e, o, t, r));
              } else if (n.type === CSSRule.SUPPORTS_RULE)
                for (let r of n.cssRules)
                  r && r.type === CSSRule.STYLE_RULE && i.push(d(e, r, t, !1));
            yield Promise.allSettled(i);
          });
        }
        function d(e, t, i) {
          return n(this, arguments, void 0, function* (e, t, i, n = !0) {
            let r = e.href || document.location.href;
            for (let e of t.style) {
              let a = t.style.getPropertyValue(e);
              if (!a) continue;
              let l = yield (0, o.inlineAll)(a, i, r, !n);
              t.style.setProperty(e, l);
            }
          });
        }
      },
      132: function (e, t) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
              ...
              n.insertBefore(
                ...
                (function () {
                  for (let e of document.querySelectorAll("style"))
                    if (e.innerHTML.includes("#root")) return e;
                  return null;
                })()
              );
          }),
          ...
          (t.dataAsUrl = function (e, t) {
            return "data:" + t + ";base64," + e;
          }),
          (t.isDataUrl = function (e) {
            return -1 !== e.search(/^(data:)/);
          }),
          (t.canvasToBlob = function (e) {
            return e.toBlob
              ...
              : Promise.resolve(
                  (function (e) {
                    let t = atob(e.toDataURL().split(",")[1]),
                      i = t.length,
                      n = new Uint8Array(i);
          ...
          (t.resolveUrl = function (e, t) {
            ...
            let r = i.createElement("a");
            return i.body.appendChild(r), (n.href = t), (r.href = e), r.href;
          }),
          (t.uid = function () {
            return (
              "u" +
              ("0000" + ((1679616 * Math.random()) | 0).toString(36)).slice(
                -4
              ) +
              l++
            );
          ...
          (t.width = function (e) {
            let t = s(e, "border-left-width"),
              i = s(e, "border-right-width");
            return e.scrollWidth + t + i;
          }),
          (t.height = function (e) {
            let t = s(e, "border-top-width"),
              i = s(e, "border-bottom-width");
            return e.scrollHeight + t + i;
          }),
          (t.isSVGElement = function (e) {
            return !!e && !!e.tagName && r.includes(e.tagName.toLowerCase());
          });
        ...
        function s(e, t) {
          return parseFloat(
            getComputedStyle(e).getPropertyValue(t).replace("px", "")
          );
        }
      },
      673: function (e, t, i) {
        ...
        var n = {},
          ...
          c = (e) => {
            ...
            if (l(e))
              for (var i, n = 0; n < e.length; n++)
                (i = c(e[n])) && (t += (t && " ") + i);
            else for (var n in e) e[n] && (t += (t && " ") + n);
            return t;
          },
          d = (e, t) => {
            for (var i in { ...e, ...t })
              if ("function" == typeof (l(e[i]) ? e[i][0] : e[i])) t[i] = e[i];
          ...
          u = (e, t, i, n, r, o) => {
            if ("style" === t)
              for (var a in { ...i, ...n })
                (i = null == n || null == n[a] ? "" : n[a]),
                  "-" === a[0] ? e[t].setProperty(a, i) : (e[t][a] = i);
            else
              "o" === t[0] && "n" === t[1]
                ? ((e.events || (e.events = {}))[(t = t.slice(2))] = n)
            ...
            var n = e.props,
              r =
                3 === e.type
                  ...
                  : document.createElement(e.tag, n.is && n);
            for (var o in n) u(r, o, null, n[o], t, i);
            for (var a = 0; a < e.children.length; a++)
              r.appendChild(f((e.children[a] = m(e.children[a])), t, i));
            return (e.node = r);
          },
          g = (e, t, i, n, r, o) => {
            if (i === n);
            else if (null != i && 3 === i.type && 3 === n.type)
              i.tag !== n.tag && (t.nodeValue = n.tag);
            else if (null == i || i.tag !== n.tag)
              (t = e.insertBefore(f((n = m(n)), r, o), t)),
                null != i && e.removeChild(i.node);
            else {
              var a,
                l,
                s,
                ...
                b = _.length - 1,
                N = y.length - 1;
              for (var T in ((o = o || "svg" === n.tag), { ...d, ...p }))
                ("value" === T || "selected" === T || "checked" === T
                  ? t[T]
                  : d[T]) !== p[T] && u(t, T, d[T], p[T], r, o);
              for (
                ;
                E <= N && v <= b && null != (s = h(_[v])) && s === h(y[E]);

              )
                g(t, _[v].node, _[v], (y[E] = m(y[E++], _[v++])), r, o);
              for (
                ;
                E <= N && v <= b && null != (s = h(_[b])) && s === h(y[N]);

              )
                g(t, _[b].node, _[b], (y[N] = m(y[N--], _[b--])), r, o);
              if (v > b)
                for (; E <= N; )
                  t.insertBefore(
                    f((y[E] = m(y[E++])), r, o),
              ...
              else if (E > N) for (; v <= b; ) t.removeChild(_[v++].node);
              else {
                for (var A = {}, S = {}, T = v; T <= b; T++)
                  null != (s = _[T].key) && (A[s] = _[T]);
                for (; E <= N; ) {
                  if (
                    ((s = h((l = _[v]))),
                    (c = h((y[E] = m(y[E], l)))),
                    S[s] || (null != c && c === h(_[v + 1])))
                  ) {
                    null == s && t.removeChild(l.node), v++;
                    continue;
                  }
                  null == c || 1 === i.type
                    ? (null == s && (g(t, l && l.node, l, y[E], r, o), E++),
                      v++)
                    : (s === c
                        ? (g(t, l.node, l, y[E], r, o), (S[c] = !0), v++)
                        : null != (a = A[c])
                        ? (g(
                            t,
                            t.insertBefore(a.node, l && l.node),
                            a,
                            y[E],
                            r,
                            o
                          ...
                          (S[c] = !0))
                        : g(t, l && l.node, null, y[E], r, o),
                      E++);
                }
                for (; v <= b; )
                  null == h((l = _[v++])) && t.removeChild(l.node);
                for (var T in A) null == S[T] && t.removeChild(A[T].node);
              }
            }
            return (n.node = t);
          },
          ...
          p = (e) =>
            3 === e.nodeType
              ? v(e.nodeValue, e)
              : _(e.nodeName.toLowerCase(), n, a.call(e.childNodes, p), 1, e),
          _ = (e, { key: t, ...i }, n, r, o) => ({
            tag: e,
            props: i,
            key: t,
          ...
          b = ({
            ...
            var h,
              ...
              y = () => (e = g(e.parentNode, e, f, (f = t(h)), v, (u = !1))),
              v = function (e) {
                a(this.events[e.type], e);
              };
            return (
              (a = a((e, t) =>
                "function" == typeof e
  ...
  (() => {
    ...
    let e = i(769);
    globalThis.Clipper = { clipArticle: e.clipArticle, clipPage: e.clipPage };
  })(),
    (module.exports = n);
})();
