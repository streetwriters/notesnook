...
import { pack, transform, IFileProvider } from "@notesnook/importer";
...
type FileProviderImportResultProps = {
  files: File[];
...
export function FileProviderImportResult(props: FileProviderImportResultProps) {
